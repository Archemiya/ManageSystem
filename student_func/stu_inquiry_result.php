...
function echo_the_student_grade_table($link)
{
    ...
    WHERE `permission` = 'student' and `id` = '{$_SESSION['user_id']}'";
    ...
    <div class="table-responsive">
        <table data-toggle="table" >
            <thead>
                <tr>
                    <th class="col-md-12 th-title-center" colspan="6">自己</th>
                </tr>
                <tr>
...
archemiya;
    for ($i = 0; $i < $num_the_student; $i++) {
        ...
        echo "<a href='student.php?func=inquiry_result&id={$row_the_topic['id']} '>" . $row_the_topic['name'] . "</a>"; //此处显示课题名称
        echo "</td>";
