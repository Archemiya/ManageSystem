...
$sql = "SELECT * FROM `final_paper_record`WHERE `topic_id` = '{$get}' AND `record_id` = '{$row_id['max(`record_id`)']}'";
...
<body>
    ...
    <?php
    if($row['final_flag']==2){
        echo "<button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#chsugTable\">修改论文终稿</button>";
    }else{
        echo "";
    }
    ?>
        ...
        <div class="chose-student-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title login-title">修改论文终稿</h4>
                </div>
                <div class="modal-body">
                    <?php
                    echo <<< archemiya
                    <form action="stu_add_final_paper.php?id={$get}" method="POST" class="form-horizontal">
                        <div class="form-group">
                            <label for="inputTopicIntro" class="col-sm-3 control-label">论文终稿摘要</label>
                            <div class="col-sm-8">
