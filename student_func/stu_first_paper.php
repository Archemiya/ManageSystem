...
/*
思路:
和开题报告基本相同，此处同样采用记录表的形式，由于阶段数少于开题报告，故使用 0 1 2 三种状态码：
 - 0 导师未审核状态 
 - 2 导师已审核，学生未修改状态
 - 1 最终审核完成状态
...
$sql_first_paper = "SELECT * FROM `first_paper_record` WHERE `student_id` = '{$_SESSION['user_id']}' AND `record_id` = '{$row_id['max(`record_id`)']}'";
...
archemiya;
        ...
        elseif (
            ...
            <td>
            <button class="btn btn-default" disabled>已上传初稿摘要</button>
            </td>
            <td>
            <button class="btn btn-default" data-toggle="modal" 
...
archemiya;
        ...
        <td>
        <a href='student.php?func=first_paper&id={$row_topic['id']}'
...
archemiya;
        ...
        <td>
        <a href='student.php?func=first_paper&fid={$row_topic['id']}'
        class="btn btn-success" role='button'>查看论文初稿</a>
        </td>
        <td>
        <a href='../uploaded_files/first_paper_files/{$row_topic['student_id']}_{$row_id['max(`record_id`)']}/{$row_first_paper['first_paper_annex_name']}'
        ...
        <div class="chose-student-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title login-title">上传论文初稿</h4>
                </div>
                <div class="modal-body">
                    <form action="stu_add_first_paper.php" method="POST" class="form-horizontal">
    ...
    <div class="modal fade " id="firstPaperAnnexTable" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="chose-student-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../file-upload.php?func=first_paper" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="inputTopicRef" class="col-sm-3 control-label">上传论文初稿附件</label>
                            <div class="col-sm-8">
                        ...
                        <?php
                        echo <<< archemiya
          <input type="hidden" name="num" value="{$num_first_paper}">
