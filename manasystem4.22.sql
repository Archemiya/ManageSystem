...
INSERT INTO `midterm_report` (`record_id`, `topic_id`, `topic_name`, `student_id`, `student_name`, `teacher_id`, `teacher_name`, `current_status`, `need_to_complete`, `current_problems_and_solutions`, `postwork_schedule`, `instructions`, `midterm_report_annex_name`, `annex_flag`, `final_flag`) VALUES
(1, 7, 'PNS攻击有效性研究及仿真验证                 ', 20189219, '黄俊豪', 1009, '刘念', '1', '1', '1', '1', '1', '第二学期课表.docx', 1, 2);
...
--
ALTER TABLE `midterm_report`
  MODIFY `record_id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
