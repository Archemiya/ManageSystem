...
<div class="container-fluid">
    ...
    echo "class=active";
                ...
                <li><a href="./student.php?func=first_report"><i class="glyphicon glyphicon-file"> 开题报告</i><span
                            class="sr-only">(current)</span></a></li>


                <li><a href="./student.php?func=midterm_report"><i class="glyphicon glyphicon-file"> 中期报告</i><span
                            class="sr-only">(current)</span></a></li>


                <li><a href="./student.php?func=guidance_record"><i class="glyphicon glyphicon-pencil"> 指导记录</i><span
                            class="sr-only">(current)</span></a></li>


                <li><a href="./student.php?func=first_draft"><i class="glyphicon glyphicon-file"> 论文初稿</i><span
                            class="sr-only">(current)</span></a></li>


                <li><a href="./student.php?func=paper_review"><i class="glyphicon glyphicon-search"> 论文查重 </i><span
                            class="sr-only">(current)</span></a></li>
                <br />
                ...
                <li><a href="./student.php?func=reply_record"><i class="glyphicon glyphicon-pencil"> 答辩记录</i><span
                            class="sr-only">(current)</span></a></li>


                <li><a href="./student.php?func=final_draft"><i class="glyphicon glyphicon-file"> 论文终稿</i> <span
                            class="sr-only">(current)</span></a></li>
                <br />

                <li><a href="./student.php?func=inquiry_result"><i class="glyphicon glyphicon-search"> 成绩查询 </i><span
                            class="sr-only">(current)</span></a></li>
