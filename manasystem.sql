...
(6, 3, '基于Apache+MySQL+PHP实现的酒店管理系统', 1007, '许盛伟', 20189219, '黄俊豪', 0),
(7, 4, '基于WEB的多媒体素材管理库的开发与应用', 1007, '许盛伟', 20189205, '黄铸君', 0),
(8, 1, '大数据平台授权模型与访问控制技术研究与实现', 1007, '许盛伟', 20189230, '杨静怡', 1),
(9, 1, '大数据平台授权模型与访问控制技术研究与实现', 1007, '许盛伟', 20189203, '邸梓航', 0),
(10, 2, '基于Linux的网络嗅探器', 1007, '许盛伟', 20189203, '邸梓航', 1);
...
CREATE TABLE `topic` (
  ...
  `topic_chosen` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
ALTER TABLE `chose_topic_record`
  MODIFY `recode_id` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
